type PinterestProps = React.SVGProps<SVGSVGElement>

function Pinterest({ className, width="24", height="24", ...props }: PinterestProps) {
  return (
    <svg
    ...
    >
      <defs>
        <path id="akarIconsPinterestFill0" fill="#fff" d="M0 0h24v24H0z"></path>
      </defs>
      <g fill="none">
        <g clipPath="url(#akarIconsPinterestFill1)">
          <g clipPath="url(#akarIconsPinterestFill2)">
            <path
              fill="currentColor"
        ...
        <defs>
          <clipPath id="akarIconsPinterestFill1">
            <use href="#akarIconsPinterestFill0"></use>
          </clipPath>
